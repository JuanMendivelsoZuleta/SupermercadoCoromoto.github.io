<?php include('./templates/cabecera.php'); ?>
    ...
    <section class="bienvenida">
        ...
        <div class="imagenes-promocion">
            <img src="./img/pro1.png" alt="Clientes comprando felices">
            <img src="./img/pro2.png" alt="Persona con carrito lleno de frutas">
            <img src="./img/pro3.png" alt="Carrito con productos variados">
        </div>
    </section>
